...
//    void stb_textedit_char(STB_TEXTEDIT_STRING *str, STB_TexteditState *state, STB_TEXTEDIT_CHARTYPE character)
//
...
// API key: process a character input
...
retry:
   switch (key) {
      default: break; //probably printable character
